...
for path in $dockerfiles; do
  ...
  docker tag "orangesys/alpine-job:${tag}" "asia.gcr.io/saas-orangesys-io/alpine-job:${tag}"
  sudo /opt/google-cloud-sdk/bin/gcloud docker -- push asia.gcr.io/saas-orangesys-io/alpine-job:${tag}
