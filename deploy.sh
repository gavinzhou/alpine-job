...
for path in $dockerfiles; do
  ...
  docker tag "orangesys/alpine-httpie:${tag}" "asia.gcr.io/orange-sys/alpine-httpie:${tag}"
  sudo /opt/google-cloud-sdk/bin/gcloud docker push asia.gcr.io/orange-sys/alpine-httpie:${tag}
